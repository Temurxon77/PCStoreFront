      ...
      <div className="carousel-inner" id="carouselInner" role="listbox"> 
        ...
        <div className="carousel-item active" >
          <div>
            ...
            <img className="card-img-top" id="images" src={photo3} style={{height: '100%'}}/>
        ...
        <div className="carousel-item">
          <div>
            <img className="card-img-top" src={photo1} style={{height: '100%'}}/>
        ...
        <div className="carousel-item">
          <div>
            ...
            <img className="card-img-top" src={photo} style={{height: '100%'}}/>

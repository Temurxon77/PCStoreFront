      ...
      <div className="carousel-inner" id="carouselInner" role="listbox">
        ...
        <div className="carousel-item active" >
          <div >
            ...
            <div className="mainbutton"><Button>Принять</Button></div>
          </div>
        ...
        <div className="carousel-item">
          <div>
            ...
            <div className="mainbutton1"><Button>Принять</Button></div>
          </div>
        </div>
        ...
        <div className="carousel-item">
          <div>
           ...
           <div className="mainbutton2" style={{color: 'white'}}><Button>Принять</Button></div>
          </div>
        </div>

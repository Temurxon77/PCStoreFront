...
const MainCarouselPage = () => {
  ...
  return (
    <div className="wrapper" style={{backgroundColor: '#090909'}}>
    <div id="video-carousel-example" className="carousel slide carousel-fade" data-ride="carousel" style={{width: '74%', marginLeft: 'auto', marginRight: 'auto'}}>
      ...
      <div className="carousel-inner" id="carouselInner" role="listbox"> 
        ...
        <div className="carousel-item active" >
          <div>
            ...
            <img className="card-img-top" src={photo3} style={{height: '500px', marginTop: '100px'}}/>
        ...
        <div className="carousel-item">
          <div>
            <img className="card-img-top" src={photo1} style={{height: '500px', marginTop: '100px'}}/>
        ...
        <div className="carousel-item">
          <div>
            ...
            <img className="card-img-top" src={photo} style={{height: '500px', marginTop: '100px'}}/>

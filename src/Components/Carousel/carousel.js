...
const MainCarouselPage = () => {
  ...
  return (
    ...
    <div id="video-carousel-example" className="carousel slide carousel-fade" data-ride="carousel" style={{marginTop: '-10px', marginLeft: 'auto', marginRight: 'auto', marginBottom: '-10px', height: '900px'}}>
      ...
      <div className="carousel-inner" id="carouselInner" role="listbox"> 
        ...
        <div className="carousel-item active" >
          <div>
            ...
            <img className="card-img-top" id="images" src={photo} style={{height: '915px'}}/>
        ...
        <div className="carousel-item">
          <div>
            <img className="card-img-top" src={photo1} style={{height: '915px'}}/>
        ...
        <div className="carousel-item">
          <div>
            ...
            <img className="card-img-top" src={photo2} style={{height: '915px'}}/>

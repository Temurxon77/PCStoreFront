      ...
      <div className="carousel-inner" id="carouselInner" role="listbox" style={{ height: '100%' }}>
        ...
        <div className="carousel-item active" style={{ position: 'relative' }}>
          <div >
            ...
            <div class="top-left"><h1 >GIGABYTE GEFORCE GTX 1650</h1></div>
        ...
        <div className="carousel-item">
          <div>
            ...
            <div class="top-left"><h1 >GIGABYTE Z390 AORUS MASTER</h1></div>
        ...
        <div className="carousel-item">
          <div>
            ...
            <div class="top-left"><h1 >PREDATOR HELIOS 300</h1></div>
